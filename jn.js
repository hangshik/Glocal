...
jn_left=['130','513','434','248','511','322','400','470','404','369','329','306','255','197','222','166','190','159','245','259','107','48'];
jn_top=['281','277','207','206','192','98','121','121','350','268','209','295','340','373','275','227','161','100','88','434','401','238'];
...
function clickbt(j) {
  ...
  function main() {
    ...
    // 5를 22로 수정할 것
      for (i = 0; i < 22; i++) {
        list.push(0);
        tag += "<div class='column' id='"+i+"' style=width:50px;height:50px;left:"+jn_left[i]+"px;top:"+jn_top[i]+"px; onclick='clickbt("+i+")'></div>";
